...
@section('content')
    ...
    @if ($bs->testimonial_section == 1)
        <section class="client-area bg_cover pt-105 pb-95 lazy"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                    <span style="    color: #C75B34 !important;
    width: fit-content;
    display: flex;
    ...
    position: relative;
    z-index: 10;
    margin: auto;">Our Testimonial <img style="position: absolute;
    left: -10px;
    top: 50%;
    transform: translateY(-50%);
    z-index: -1;
" src="http://dev.mittichulha.com/assets/front/img/title-icon.png" alt=""></span>
    ...
    @if ($bs->news_section == 1)
        <section class="blog-area pb-130">
            <div class="container">
                ...
                <div class="row justify-content-center blogcardparent">
                    @foreach ($blogs as $blog)
                        <div class="col-lg-4 col-md-8 shadowcard">
